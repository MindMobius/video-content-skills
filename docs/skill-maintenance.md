...
### 已发生案例：载体已变成文章，视角和删节痕迹却没有变

症状是正文信息与截图都完整，却仍反复写“视频里”“视频认为”“创作者指出”，像在介绍另一条
视频；商品推广虽然删除，正文却保留“视频原文中的商品推广段”一类占位说明。旧合同只检查来源
忠实、章节覆盖和表达模板，没有明确区分“来源直接叙述”与“第三方视频解说壳”，也没有规定
非实质片段必须无痕省略。

修复仍然不是关键词替换。Agent 先判断某个“视频”是否是实际讨论对象、是否承担必要归属，再把
纯载体外壳改为来源叙述视角；同时把广告、赞助口播和平台 CTA 与必要利益披露分开，前者记录在
...
4. **载体变成文章，叙述视角也要完成转换。** 来源声明应集中，正文直接承载来源表达；只有当视频、
