...
| --- | --- | --- |
| One hierarchy, comparison, cycle, or causal chain | One-page visual | Qualifications require footnote-sized text |
| Several modular ideas with meaningful order | Card series | Cards become isolated slogans |
| Deep argument with dependent premises | Article | Headings hide missing logical transitions |
| Few conclusions for rapid orientation | Brief | Omitted support makes conclusions sound absolute |
| Spoken explanation, demonstration, or narrative | Script | Oral simplification removes attribution or limits |

Visual potential means a relationship becomes easier to understand through
...
Narrative voice is also carrier design. A single-author adaptation normally
speaks directly from that author's perspective. Interviews and debates retain
